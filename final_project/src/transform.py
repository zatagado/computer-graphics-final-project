...
class Transform:
    ...
    def set_position(self, x, y=None, z=None):
        """Takes three scalars (x, y, and z) as input, and updates 
    ...
    def __rotate_x(self, degrees):
        """Takes a scalar (x) as input, and updates the Transform objects 
        internal rotation state on the x axis.
        """
    ...
    def __rotate_y(self, degrees):
        """Takes a scalar (y) as input, and updates the Transform objects 
        internal rotation state on the y axis.
        """
        radians = math.radians(degrees)
    ...
    def __rotate_z(self, degrees):
        """Takes a scalar (z) as input, and updates the Transform objects 
        internal rotation state on the z axis.
        """
        radians = math.radians(degrees)
    ...
    def set_rotation(self, x, y, z):
        """Takes three scalars (x, y, and z) as input, and updates 
        the Transform object's internal rotation state. The input values x, y, 
        and z are expected to be degrees values between 0.0 and 360.0, and 
        represent the amount of rotation around the x, y, and z axis 
        respectively.
        """
    ...
    def inverse_matrix(self):
        """Returns a 4x4 Numpy matrix that is the inverse of the 
    ...
    def apply_to_point(self, p: np.ndarray):
        """Takes a 3 element Numpy array, p, that represents a 3D 
    ...
    def apply_to_normal(self, n: np.ndarray):
        """Takes a 3 element Numpy array, n, that represents a 3D 
    ...
    def set_axis_rotation(self, axis: np.ndarray, rotation):
        """Takes a 3D numpy array as the axis input, and a scalar 
        in degrees as the rotation input. Calculates the rotation resulting 
        from the amount of input rotation rotating around the input axis and 
        update its internal rotation representation as such.
        """
    ...
    def set_rotation_towards(self, direction):
        """Takes a 3D numpy array as the direction vector input. This method 
        aligns the rotation of the Transform object with the direction vector.
        """
