...
if __name__ == '__main__':
    ...
    mesh_1.transform.set_position(0, 0, 1)
    ...
    shadow_map = ShadowMap([mesh_1, mesh_2], light, OrthoCamera(7, -7, -7, 7, 5.0, -20), (screen.width, screen.height), 0)
    
    #* Grouping for rendering from camera pov
    renderer = Renderer(screen, shadow_map.orthoCamera, [mesh_1, mesh_2], light, shadow_map)
    renderer.render("debug", [80, 80, 80], [0.2, 0.2, 0.2]) # TODO find out the issue with the ambient light when color is changed
